    ...
    <div className="space-y-16">
      ...
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link to="/upload" className="inline-flex items-center px-8 py-3 text-lg font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">
            <CloudArrowUpIcon className="w-5 h-5 mr-2" />
            Upload Video
          </Link>
          <Link to="/history" className="inline-flex items-center px-8 py-3 text-lg font-medium text-gray-900 bg-gray-200 rounded-lg hover:bg-gray-300 transition-colors">
      ...
      {/* CTA Section */}
      <div className="bg-blue-600 py-12 sm:py-16 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link 
              to="/upload" 
              className="rounded-md bg-white px-8 py-3 text-lg font-semibold text-blue-600 shadow-sm hover:bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            >
              Get Started
            </Link>
          </div>
